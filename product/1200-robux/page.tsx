      ...
      <main className="product-container">
        ...
        <section className="product-frame">
          ...
          <div className="product-left">
            ...
            <div className="pl-section">
              ...
              <ol className="pl-list">
                ...
                <li>Clique no ícone <em>Resgatar</em> e insira o código PIN recebido;</li>
                <li>Após aparecer o saldo na sua conta, é só usar e ser feliz!</li>
              </ol>
          ...
          <aside className="product-buy">
            <p className="product-sold">+178 Vendidos</p>
            ...
            <div className="product-stars">
              ...
              <span className="muted">108 avaliações</span>
            </div>
            ...
            <button onClick={handleBuyNow} className="btn-buy">COMPRAR AGORA</button>
            <button onClick={handleAddToCart} className="btn-cart">ADICIONAR AO CARRINHO</button>
