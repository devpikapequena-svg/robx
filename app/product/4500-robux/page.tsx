...
export default function ProductPage() {
  ...
  const handleBuyNow = () => {
    ...
    router.push("/cart"); // redireciona pro carrinho
  };

  const handleAddToCart = () => {
    addToCart({ ...product, qty }); // só adiciona ao carrinho
  };
      ...
      <main className="product-container">
        ...
        <section className="product-frame">
          ...
          <aside className="product-buy">
            <p className="product-sold">+189 Vendidos</p>
            ...
            <div className="product-stars">
              ...
              <span className="muted">96 avaliações</span>
            </div>
